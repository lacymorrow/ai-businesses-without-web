...
import type { WebsiteType } from "../_types/business";
...
const BUSINESS_CATEGORIES = [
	...
	{ value: "clothing_store", label: "Retail Stores" },
...
const WEBSITE_TYPES: { value: WebsiteType | "all"; label: string }[] = [
		...
		<form onSubmit={handleSubmit} className="space-y-6">
			<div className="grid gap-4 md:grid-cols-2">
				...
				<div className="space-y-2">
					...
					<Select value={radius || "5000"} onValueChange={(value) => setRadius(value)}>
